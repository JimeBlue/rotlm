<template>
  <div>
    <div class="flex justify-between border-b border-gray-200 py-3.5 dark:border-gray-700">
      <UInput
...
const companions = computed(() => user.value?.companion_guests || [])
...
function close() {
  editModal.cancel()
  // TODO: Get user / main guest again
}
