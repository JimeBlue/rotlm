      ...
      >
        ...
        >
          <button
            ...
            type="button"
            class="group absolute top-4 right-6"
            aria-label="Close"
          ...
          >
            <svg
              ...
              class="h-6 w-6 text-green-neon transition duration-200 group-hover:scale-125 group-hover:rotate-3"
            >
              <path
                stroke="none"
                d="M0 0h24v24H0z"
          ...
          <div
            class="flex flex-1 flex-col overflow-y-auto modal-scrollbar"
...
.modal-scrollbar {
  ...
  scrollbar-color: var(--color-green-neon) transparent;
}
</style>
